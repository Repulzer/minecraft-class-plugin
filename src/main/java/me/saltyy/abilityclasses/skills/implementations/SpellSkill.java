...
import me.saltyy.abilityclasses.skills.skilldata.Spell.Spell;
import me.saltyy.abilityclasses.skills.skilldata.Spell.SpellData;
...
public class SpellSkill extends SkillImplementation {
    ...
    public void bookWrite(PlayerEditBookEvent e) {
        if (e.isSigning()) {
            ...
            Collection<SkillData> skillDatas = powersHandler.getPlayerclass(player).getSkillData(Skill.SPELL);
