...
import me.saltyy.abilityclasses.skills.skilldata.ConvertDropsData;
...
public class ConvertDropsSkill extends SkillImplementation{
    ...
    public void onBreak(BlockBreakEvent e) {
        ...
        Collection<SkillData> skillDatas = powersHandler.getPlayerclass(player).getSkillData(Skill.CONVERTDROPS);
